...
# ── Column name overrides (dual-DB compatibility) ─────────────────────────────
# Old DB (jobapplier)    → set CREDENTIAL_PLATFORM_COL=domain  FORM_ANSWER_PLATFORM_COL=domain
# New DB (jobapplier_v2) → default "platform" (no override needed)
CREDENTIAL_PLATFORM_COL  = table_name("CREDENTIAL_PLATFORM_COL",  "platform")
FORM_ANSWER_PLATFORM_COL = table_name("FORM_ANSWER_PLATFORM_COL", "platform")
